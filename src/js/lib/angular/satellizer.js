...
(function (global, factory) {
    ...
    var AuthProvider = (function () {
        ...
        AuthProvider.prototype.slack = function (options) {
            angular.extend(this.SatellizerConfig.providers.slack, options);
        };
    ...
    var OAuth2 = (function () {
        ...
        OAuth2.prototype.exchangeForToken = function (oauthData, userData) {
            ...
            payload.provider = this.defaults.name;
            var exchangeForTokenUrl = this.SatellizerConfig.baseUrl ?
                joinUrl(this.SatellizerConfig.baseUrl, this.defaults.url) :
                this.defaults.url;
            return this.$http.put(exchangeForTokenUrl, { data : payload }, { withCredentials: this.SatellizerConfig.withCredentials });
        };
